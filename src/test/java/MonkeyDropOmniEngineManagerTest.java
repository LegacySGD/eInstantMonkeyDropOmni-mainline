...
public class MonkeyDropOmniEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(MonkeyDropOmniEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/MonkeyDropOmni/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/MonkeyDropOmni/InitOutcome.xml").getDocumentElement();
